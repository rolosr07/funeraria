...
public class VerVelasActivity extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ver_velas);
        ...
        handler.postDelayed(new Runnable() {
            public void run() {
                Intent i = new Intent(VerVelasActivity.this, VerMensajesActivity.class);
    ...
    final Runnable createUIImages = new Runnable() {
        ...
        public void run(){
            ...
            if(!webResponseImages.equals("") && !webResponseImages.equals("[]")){
                ...
                mCustomPagerAdapter = new CustomPagerServicesAdapter(VerVelasActivity.this, lcs);
