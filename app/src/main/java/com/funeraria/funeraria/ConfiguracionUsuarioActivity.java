...
public class ConfiguracionUsuarioActivity extends Base {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCerrarSession.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setUser(null);
                Intent intent = new Intent(ConfiguracionUsuarioActivity.this, MainActivity.class);
    ...
    final Runnable createUI = new Runnable() {
        ...
        public void run(){
            ...
            if(result){
                ...
                showProgress(false);
                Toast.makeText(ConfiguracionUsuarioActivity.this, "Se ha actualizado el usuario, por favor inicie sesión nuevamente!", Toast.LENGTH_LONG).show();

                Handler handler = new Handler();
                handler.postDelayed(new Runnable() {
                    public void run() {
                        Intent i = new Intent(ConfiguracionUsuarioActivity.this, LoginActivity.class);
